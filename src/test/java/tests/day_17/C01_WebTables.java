...
public class C01_WebTables {
    ...
    public void test(){
        ...
        //1. page sayfasinda Bir metod oluşturun : printData(int row, int column);
 ...
 String actualData=   qaConcortPage.printData(3,4);
        ...
        //assertu bu classta yapmak istiyorsak, istenen datanin bu classa donmesini saglamaliyiz.
